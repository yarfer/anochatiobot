...
access_token = '859434069:AAHz3EpSGfP2L0CDGyjjk2mgyF2MgEsfaMs'
        ...
        with open(chat_ids_file, "a+") as ids_file:
            ...
            if num1 in ids_list:
                ...
                if message.content_type == 'sticker':
                    ...
                    elif user_id == adminid1 and message.text=="getban":
                                doc = open(chat_ids_file, 'rb')
                                bot.send_document(adminid1, doc)
                                doc.close()

                    elif user_id == adminid1 and message.text=="getid":
                                doc1 = open(chat_ids_file1, 'rb')
